        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row lg:max-w-4xl lg:justify-end">
          <div className="relative flex-1">
            ...
            <input
              ...
              className={`h-12 w-full rounded-2xl border border-gray-100 bg-gray-50/50 text-sm outline-none transition-all duration-300 focus:border-emerald-500/30 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 ${isRTL ? "pl-4 pr-11" : "pl-11 pr-4"}`}
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex h-12 items-center gap-2 rounded-2xl border border-gray-100 bg-white px-6 text-sm font-bold text-gray-600 transition-all duration-300 hover:bg-gray-50 hover:text-emerald-500 hover:shadow-md"
            >
              <Filter size={18} />
