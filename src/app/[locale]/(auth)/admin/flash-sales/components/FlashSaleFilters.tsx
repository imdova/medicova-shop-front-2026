...
import { Search, Filter, RotateCcw, Download, Plus } from "lucide-react";
...
const FlashSaleFilters: React.FC<FlashSaleFiltersProps> = ({
  locale,
  searchQuery,
  onSearchChange,
  onToggleFilters,
        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row lg:max-w-4xl lg:justify-end">
          <div className="relative flex-1">
            ...
            <input
              ...
              className={`h-12 w-full rounded-2xl border border-gray-100 bg-gray-50/50 text-sm outline-none transition-all duration-300 focus:border-rose-500/30 focus:bg-white focus:ring-4 focus:ring-rose-500/5 ${isRTL ? "pl-4 pr-11" : "pl-11 pr-4"}`}
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex h-12 items-center gap-2 rounded-2xl border border-gray-100 bg-white px-6 text-sm font-bold text-gray-600 transition-all duration-300 hover:bg-gray-50 hover:text-rose-500 hover:shadow-md"
            >
              <Filter size={18} />
            ...
            <Link
              href={`/${locale}/admin/flash-sales/create`}
              className="flex h-12 items-center gap-2 rounded-2xl bg-rose-500 px-6 text-sm font-bold text-white shadow-xl shadow-rose-500/20 transition-all duration-300 hover:brightness-110 active:scale-95"
            >
              <Plus size={18} />
...
export default FlashSaleFilters;
