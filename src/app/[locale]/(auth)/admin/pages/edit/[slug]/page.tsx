...
import {
  BilingualInput,
  BilingualTextEditor,
} from "@/components/features/PageEditor/BilingualInput";
import ImageUpload from "@/components/features/PageEditor/ImageUpload";
import { useParams } from "next/navigation";
import { FAQManager } from "@/components/features/PageEditor/FAQManager";
import SEOManager from "@/components/features/PageEditor/SEOManager";
import {
  faqSchema,
  pageSchema,
  seoSchema,
...
export default function EditPage() {
  ...
  const [activeEditorLang, setActiveEditorLang] = useState<"en" | "ar">(locale);
