                    ...
                    <div className="flex flex-col justify-between md:flex-row">
                      <div className="flex gap-3 p-3">
                        <Image
                          ...
                          alt={product.title[locale] ?? "product name"}
                        />
                        <div className="max-w-xs">
                          ...
                          <p className="text-xs text-gray-600">
                            {product.specifications
                              .map(
                                (specification) =>
                                  `(${specification.label[locale]}: ${specification.content[locale]})`,
                              )
                              .join(", ")}
                          </p>
                          {product.sku && (
                  ...
                  <div>
                    ...
                    <p>
                      {typeof currentShipment.shippingMethod === "object"
                        ? currentShipment.shippingMethod[locale]
                ...
                <CardContent className="space-y-3">
                  <div className="font-semibold">
                    {typeof currentShipment.customer.firstName === "object"
                      ? currentShipment.customer.firstName[locale]
