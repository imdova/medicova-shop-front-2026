...
import { CategoriesSelector } from "@/components/features/page_old/products-attribute/CategoriesSelector";
import { ColorPicker } from "@/components/features/ColorPicker";
import { useParams } from "next/navigation";
import { ProductAttributes } from "@/data";
import AttributeImageUpload from "@/components/features/page_old/products-attribute/AttributeImageUpload";
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="flex items-center gap-2 text-2xl font-bold">
          ...
          <span className="text-sm font-normal text-gray-500">
            ({t.editing}: {attributeToEdit.name[locale]})
          </span>
        </h1>
      </div>
