      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row lg:max-w-4xl lg:justify-end">
          ...
          <div className="flex gap-2">
            ...
            <button className="flex h-12 items-center gap-2 rounded-2xl border border-gray-100 bg-rose-50 px-4 text-sm font-bold text-rose-600 transition-all duration-300 hover:bg-rose-600 hover:text-white hover:shadow-lg">
              <Download size={18} />
            </button>
            <button
              onClick={onCreate}
