    ...
    <div className="space-y-6" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          {locale === "en" ? `Editing: ${slug}` : `جاري التعديل: ${slug}`}
        </p>
      </div>
                ...
                <Card className="relative mb-4 overflow-hidden rounded-lg border border-gray-200 py-0 shadow-sm">
                  ...
                  <CardHeader className="bg-gradient-to-r from-primary to-secondary text-white">
                    <h3 className="py-2 text-3xl font-bold drop-shadow-md">
                      {
                        // Safe fallback: prefer current locale → fallback to other → fallback to t.free
                        watchName?.[locale] ||
                          watchName?.[locale === "ar" ? "en" : "ar"] ||
                          t.free
                      }
                    </h3>
                  </CardHeader>
