      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit(submitHandler)} className="space-y-4">
              ...
              <input
                ...
                {...register("cardNumber", {
                  ...
                  validate: (value) => {
                    ...
                    return digits.length === 16 || t("invalidCardNumber");
                  },
                })}
                ...
                <input
                  ...
                  {...register("expiryMonth", {
                    ...
                    validate: (value) => {
                      ...
                      return (month >= 1 && month <= 12) || t("invalidMonth");
                    },
                  })}
                ...
                <input
                  ...
                  {...register("expiryYear", {
                    ...
                    validate: (value) => {
                      ...
                      return (
                        year >= currentYear ||
                        t("yearInvalid", { year: currentYear })
                      );
                    },
                  })}
              ...
              <div className="mt-1">
                <input
                  ...
                  {...register("cvv", {
                    ...
                    validate: (value) => {
                      return value.length === 3 || t("cvvInvalid");
                    },
                  })}
          ...
          <div>
            ...
            >
              {isSubmitting ? t("processing") : t("addCard")}
            </button>
          </div>
        </form>
      </div>
