...
import MobileDropdown from "../../layouts/MobileDropdown";
      ...
      >
        <div className="flex items-center gap-2">
          {filterGroups.map((group) => (
            <div
              key={group.name["en" as keyof LocalizedTitle]}
            ...
            >
              ...
              >
                {group.name[locale as keyof LocalizedTitle]}
                {group.options?.length &&
      ...
      {selectedGroup && openTapDropdown && (
        <>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={t("searchIn", {
                      name: selectedGroup.name[locale as keyof LocalizedTitle],
                    })}
                    value={searchTerm}
          ...
          <div className="md:hidden">
            <MobileDropdown
              label={selectedGroup.name[locale as keyof LocalizedTitle]}
              isOpen={isDrawerOpen}
